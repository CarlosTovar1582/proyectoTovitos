...
const people = [
    {
      ...
      imageUrl:
        'https://i.postimg.cc/25vstTTy/Salditos.png',
      xUrl: '#',
      linkedinUrl: '#',
    },
    // More people...
    ...
    return (
        <div className=" py-10 sm:py-32">
            ...
            <div className="mx-auto max-w-2xl">
                <h2 className="text-4xl font-Londrina-Shadow  drop-shadow-[0_1.2px_4.2px_rgba(0,0,0,0.8)] tracking-[.15em] text-black sm:text-5xl">SALDITOS</h2>
            ...
            >
                ...
                <li key={person.name} className="rounded-2xl bg-gray-800 px-8 py-10">
                    <img alt="" src={person.imageUrl} className="mx-auto size-48 rounded-3xl md:size-56" />
